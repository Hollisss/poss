      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
         <div class="container-fluid">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?=base_url()?>"><?php if($this->setting->logo){ ?><img src="<?=base_url()?>files/Setting/<?=$this->setting->logo;?>" alt="logo"  style='max-height: 45px; max-width: 200px'><?php } else { ?><img src="<?=base_url()?>assets/img/logo.png" alt="logo"><?php } ?></a>
            </div>
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                  <li class="flat-box"><a href="<?=base_url();?>"><i class="fa fa-credit-card"></i> <?=label("POS");?></a></li>
                 <li class="flat-box"><a href="<?=base_url()?>products"><i class="fa fa-archive"></i> <?=label("Product");?></a></li>
                 <li class="dropdown">
                 ...
                 <li class="dropdown">
                    <a href="#" class="dropdown-toggle flat-box" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ticket"></i> <?=label("Sales");?> <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                       <li class="flat-box"><a href="<?=base_url()?>sales"><i class="fa fa-user"></i> <?=label("Active");?></a></li>
                       <li class="flat-box"><a href="<?=base_url()?>sales/cancelled"><i class="fa fa-truck"></i> <?=label("Cancelled");?></a></li>
                    </ul>
                 </li>
                 <!--li class="flat-box"><a href="<?=base_url()?>sales"><i class="fa fa-ticket"></i> <?=label("Sales");?></a></li-->
                 <li class="flat-box"><a href="<?=base_url()?>expences"><i class="fa fa-usd"></i> <?=label("Expense");?></a></li>
                 <li class="flat-box"><a href="<?=base_url()?>receiptvouchers"><i class="fa fa-usd"></i> <?=label("Receiptvoucher");?></a></li>
               ...
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown language">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li class="flat-box"><a href="<?=base_url()?>dashboard/change/arabic"><img src="<?=base_url()?>assets/img/flags/ar.png" class="flag" alt="language"> عربى</a></li>
