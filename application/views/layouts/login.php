       ...
       <div class="modal-dialog">
            <div class="loginmodal-container">
              ...
              <div class="login-help">
               &copy; <?=date("Y");?> <!--<?=$this->setting->companyname?>-->Made By  <a href="https://progmart.net" target="_blank" style="color:#158765; font-family: 'futura_ltbook', sans-serif; font-size: 15px; font-weight: bold;" >ProgMart Developers Team</a>
               <br><br>
              </div>
            </div>
         </div>
