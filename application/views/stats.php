<div class="container">
      <div class="row" style="margin-top:60px;">
        ...
        <h2 style="display: inline"><?=$CustomerNumber;?><br></h2><br>
      ...
      <div class="col-md-4">
        ...
        <h2 style="display: inline"><?=$ProductNumber;?><br></h2><br>
      ...
      <div class="col-md-4">
        ...
        <h2 style="display: inline"><?=$TodaySales;?> <?=$this->setting->currency;?><br></h2><br>
      ...
      <div class="row" style="margin-top:60px;">
        ...
        <h2 style="display: inline"><?=$TodayExpences;?> <?=$this->setting->currency;?><br></h2><br>
        <span><?=label('TodayExpences');?></span>
        </div>
      </div>
      <div class="col-md-4">
         <div class="statCart Statcolor05">
        <i class="fa fa-smile-o" aria-hidden="true"></i>
        <h2 style="display: inline"><?=$TodayProfit;?> <?=$this->setting->currency;?><br></h2><br>
        <span><?=label('TodayProfit');?></span>
        </div>
      </div>
      <div class="col-md-4">
         <div class="statCart Statcolor06">
        <i class="fa fa-usd" aria-hidden="true"></i>
        <h2 style="display: inline"><?=$Todayreceiptvoucher;?> <?=$this->setting->currency;?><br></h2><br>
        <span><?=label('Todayreceiptvoucher');?></span>
        </div>
      </div>
   </div>
   ...
   <!-- ********************************************* warehouses report ***************************************************** -->
   <div class="row rangeStat" style="margin-top:50px;">
      <h3 class="col-sm-12"><?=label('Stock stats');?></h3>
      <div class="col-md-5">
         <div class="form-group">
             <label for="customerSelect"><?=label('SelectStore');?></label>
