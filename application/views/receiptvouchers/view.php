  <div class="container">
   ...
   <button type="button" class="btn btn-add btn-lg" data-toggle="modal" data-target="#AddReceiptvouchers">
	<?=label("AddReceiptvouchers");?>
   </button>
   ...
   <!-- Button trigger modal -->
   <a href="<?=base_url()?>categorie_receiptvouchers" class="btn btn-add btn-lg">
     <?=label("Category");?>
   </a>
   </div>
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('receiptvouchers_controller/ajax_list')?>",
            "type": "POST"
        },
    ...
    function delete_receiptvouchers(id)
    {
      ...
      function(){
         ...
         $.ajax({
            url : "<?php echo site_url('receiptvouchers_controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
  ...
  <!-- Modal -->
  <div class="modal fade" id="AddReceiptvouchers" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="myModalLabel"><?=label("AddReceiptvouchers");?></h4>
        </div>
        <?php
        $attributes = array('id' => 'addform');
        echo form_open_multipart('receiptvouchers/add', $attributes);
        ?>
...
<div class="modal fade" id="Addcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('categorie_receiptvouchers/add/receiptvouchers'); ?>
      <div class="modal-body">
           <div class="form-group">
