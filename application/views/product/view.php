...
<div class="container">
             ...
             <?php foreach ($products as $product):?>
              <tr>
                 ...
                 <td><div class="btn-group">
                       ...
                       <a class="btn btn-default" href="javascript:void(0)" data-toggle="modal" data-target="#barcode" onclick="productBcode = '<?=$product->code;?>'; product_ID = '<?=$product->id;?>';"><i class="fa fa-barcode" data-toggle="tooltip" data-placement="top" title="<?=label('printBarcodes');?>"></i></a>
                     </div>
                  </td>
              </tr>
           <?php endforeach;?>
   ...
   <!-- Button trigger modal -->
   <a href="<?=base_url()?>categories" class="btn btn-add btn-lg">
     <?=label("Category");?>
   </a>
   </div>
...
<div class="modal fade" id="Addcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('categories/add/products'); ?>
...
function barcode(){
   ...
   num = $('#Brnum').val();
   $.ajax({
       url : "<?php echo site_url('productcontroller/barcode')?>/"+row+"/"+num+"/"+productBcode+"/"+product_ID,
       type: "POST",
       success: function(data)
       {
...
var divToPrint=document.getElementById('printSection');
  ...
  newWin.document.write('<html><link href="https://fonts.googleapis.com/css?family=Lato:400,700,900,300" rel="stylesheet" type="text/css"><link href="<?=base_url();?>assets/css/bootstrap.min.css" rel="stylesheet"><link href="<?=base_url();?>assets/css/bootstrap-horizon.css" rel="stylesheet"><body onload="window.print()" >'+divToPrint.innerHTML+'</body></html>');
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="btn-group white" data-toggle="buttons">
              ...
              <label class="btn color09">
                 <input type="radio" name="color" id="option9" value="color09" autocomplete="off"> C9
              </label>
              <label class="btn color10">
                 <input type="radio" name="color" id="option10" value="color10" autocomplete="off"> C10
              </label>
              <label class="btn color11">
                 <input type="radio" name="color" id="option11" value="color11" autocomplete="off"> C11
              </label>
              <label class="btn color12">
                 <input type="radio" name="color" id="option12" value="color12" autocomplete="off"> C12
              </label>
              <br></br>
              <label class="btn color13">
                 <input type="radio" name="color" id="option13" value="color13" autocomplete="off"> C13
              </label>
              <label class="btn color14">
                 <input type="radio" name="color" id="option14" value="color14" autocomplete="off"> C14
              </label>
              <label class="btn color15">
                 <input type="radio" name="color" id="option15" value="color15" autocomplete="off"> C15
              </label>
              <label class="btn color16">
                 <input type="radio" name="color" id="option16" value="color16" autocomplete="off"> C16
              </label>
              <label class="btn color17">
                 <input type="radio" name="color" id="option17" value="color17" autocomplete="off"> C17
              </label>
              <label class="btn color18">
                 <input type="radio" name="color" id="option18" value="color18" autocomplete="off"> C18
              </label>
              <label class="btn color19">
                 <input type="radio" name="color" id="option19" value="color19" autocomplete="off"> C19
              </label>
              <label class="btn color20">
                 <input type="radio" name="color" id="option20" value="color20" autocomplete="off"> C20
              </label>
           </div>
      </div>
      <div class="modal-footer">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-body">
           ...
           <div class="form-group col-md-6">
             ...
             <input type="number" Required name="num" class="form-control" id="Brnum" placeholder="<?=label("Number");?>" value="1">
           </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default hiddenpr" data-dismiss="modal"><?=label("Close");?></button>
