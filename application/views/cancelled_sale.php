  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('cncld_invoices/ajax_list')?>",
            "type": "POST"
        },
    ...
    function delete_invoice(id)
    {
      ...
      function(){
         ...
         $.ajax({
            url : "<?php echo site_url('cncld_invoices/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
    ...
    function showTicket(id){
      ...
      $.ajax({
          url : "<?php echo site_url('cncld_invoices/ShowTicket')?>/"+id,
          type: "POST",
          success: function(data)
          {
    ...
    function showInvoice(id){
      ...
      $.ajax({
          url : "<?php echo site_url('cncld_invoices/showInvoice')?>/"+id,
          type: "POST",
          success: function(data)
          {
    ...
    function Edit_Sale(id){
      ...
      $.ajax({
          url : "<?php echo site_url('cncld_invoices/Edit_Ajax')?>/"+id,
          type: "POST",
          success: function(data)
          {
    ...
    function update_Sale(){
      ...
      $.ajax({
          url : "<?php echo site_url('cncld_invoices/Update_Sale')?>/"+id,
...
var saleID;
    function payaments(id){
      saleID = id;
      $.ajax({
          url : "<?php echo site_url('cncld_invoices/payaments')?>/"+id,
          type: "POST",
          success: function(data)
          {
    ...
    function AddPayement(type){
     ...
     $.ajax({
         url : "<?php echo site_url('cncld_invoices/Addpayament')?>/"+type,
         type: "POST",
         ...
         success: function(data)
         {
            $('#payementsSection').load("<?php echo site_url('cncld_invoices/payaments')?>/"+saleID);
...
function deletepayement(id){
   $.ajax({
       url : "<?php echo site_url('cncld_invoices/deletepayement')?>/"+id+"/"+saleID,
       type: "POST",
       success: function(data)
       {
          $('#payementsSection').load("<?php echo site_url('cncld_invoices/payaments')?>/"+saleID);
